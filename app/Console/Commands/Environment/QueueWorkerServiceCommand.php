...
class QueueWorkerServiceCommand extends Command
{
    ...
    {
        $serviceName = $this->option('service-name') ?? $this->ask('Queue worker service name', 'turbo-queue');
...
After=redis-server.service' : '';
        ...
        $success = File::put($path, "# TurboPanel Queue File
# ----------------------------------

[Unit]
Description=TurboPanel Queue Service$afterRedis
